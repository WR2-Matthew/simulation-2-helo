      ...
      <div className='authHolder'>
        <div className='authForm'>
          ...
          <div className='authInput'>
            ...
            <input name='username' value={username} className='authInputs' onChange={(e) => this.handleChange(e)} />
            <label>Password:</label>
            <input name='password' value={password} className='authInputs' onChange={(e) => this.handleChange(e)} />
          </div>
