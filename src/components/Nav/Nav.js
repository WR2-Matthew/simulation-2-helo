...
import { setUser, logoutRedux } from '../../redux/actionCreators';
...
class Nav extends Component {
  ...
  componentDidMount = () => {
    axios
      .get('/api/session')
      .then(res => this.props.setUser(res.data.username, res.data.profilePicture, res.data.id))
  }

  logoutUser = () => {
    axios
      .post('/auth/logout')
      .then(() => this.props.logoutRedux())
  };
...
export default connect(mapStateToProps, { setUser, logoutRedux })(Nav);
