...
class Auth extends Component {
  ...
  login = () => {
    ...
    axios
      ...
      .then(res => {
        this.props.setUser(res.data.username, res.data.profilePicture, res.data.id)
        ...
        <div className='authForm'>
          ...
          <div className='authInputHolder'>
            <div className='inputBoxes'>
              ...
              <input placeholder='Username' name='username' value={username} className='authInputs' onChange={(e) => this.handleChange(e)} />
            </div>
